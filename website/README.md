...
If you don't want to install Hugo, CUE, Node.js, Rust, or [vdev] locally, you can use Docker instead. The first startup installs the matching vdev version (or builds the checkout when it is unreleased).
